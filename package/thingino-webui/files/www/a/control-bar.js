(function () {
  ...
  function isCurrentPath(targetPath) {
    ...
    const current = normalizePath(
      globalConfig.activePath || window.location.pathname,
    );
  ...
  function createDropdownMenu() {
    ...
    const items = [
      ...
      {
        type: "link",
        href: "/config-photosensing.html",
        icon: "bi bi-gear",
        label: "Photosensing Config",
        title: "Photosensing Config",
      },
      {
        type: "link",
  ...
  function buildControlRow(placeholder) {
    ...
    const wrapperClass =
      placeholder.dataset.wrapperClass || defaults.wrapperClass;
